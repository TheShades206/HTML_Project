...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String languageCode = Message.LANG_ENGLISH;
        String username;
        String password;
        String captchaInput;
        ...
        while (true) {
            ...
            // Hien thi menu
            System.out.println(bundle.getString(Message.KEY_MENU_TITLE));
            System.out.print(bundle.getString(Message.KEY_MENU));

            try {

                // Nguoi dung nhap lua chon menu
                System.out.print(bundle.getString(Message.KEY_MENU_CHOICE));
                option = Validation.getMenuOption(scanner.nextLine(), bundle.getString(Message.KEY_ERR_INVALID_OPTION));
                ...
                BundleUtils.setLanguage(languageCode);
                bundle = BundleUtils.getBundle();

                // Hien thi lai title dang nhap theo yeu cau
                System.out.println(bundle.getString(Message.KEY_MENU_TITLE));
                ...
                requestDTO.setCaptchaInput(captchaInput);
                requestDTO.setLanguageCode(languageCode);

                // Goi controller xu ly dang nhap
                controller.processLogin(requestDTO,
                        bundle.getString(Message.KEY_LOGIN_SUCCESS),
                        bundle.getString(Message.KEY_LOGIN_FAIL));

            } catch (Exception e) {

                // Bat loi khi nguoi dung nhap sai
                System.out.println(e.getMessage());
            }
        }
    }
